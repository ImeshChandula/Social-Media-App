...
//         // Calculate the current like count from the updated likes array
//         const currentLikeCount = updatedPost.likes ? updatedPost.likes.length : 0;
//         const isCurrentlyLiked = updatedPost.likes ? updatedPost.likes.includes(userId) : false;
...
//             currentLikeCount,
//             isCurrentlyLiked,
//             likesArray: updatedPost.likes
//         });

//         return res.status(200).json({ 
//             success: true, 
//             message: `Successfully ${actionPerformed} this post`,
//             data: {
//                 post: updatedPost.id,
//                 likeCount: currentLikeCount,
//                 isLiked: isCurrentlyLiked,
//                 actionPerformed // Added for debugging
//             }
//         });
//     } catch (error) {
//         console.error('Error in toggleLike controller:', error);
