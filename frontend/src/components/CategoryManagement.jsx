                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap' }}>
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...styles.actionButton(category.isActive ? '#f56565' : '#48bb78'),
                                                    background: category.isActive ? 'rgba(245, 101, 101, 0.1)' : 'rgba(72, 187, 120, 0.1)',
                                                    fontSize: '12px',
                                                    padding: '4px 8px'
                                                }}
                                            >
                                    ...
                                    <tr key={category.id}>
                                        ...
                                        <td style={styles.td}>
                                            <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap' }}>
                                                ...
                                                <button
                                                    onClick={() => handleToggleStatus(category.id, category.isActive)}
                                                    style={styles.actionButton(category.isActive ? '#f56565' : '#48bb78')}
                                                    onMouseEnter={(e) => {
                                                        e.target.style.background = category.isActive 
