...
const CreatePagePost = ({ pageId, pageData, onPostCreated, onCancel, isModal = false }) => {
  ...
  const cardClass = isModal ? "" : "card card-body p-4 text-dark rounded-4 shadow-sm bg-white";
      ...
      <div className={cardClass}>
        {!isModal && pageData && (
          <div className="d-flex align-items-center mb-4 p-3 bg-light rounded">
            ...
            />
            <div>
              <h6 className="mb-0 fw-bold text-dark">{pageData.pageName}</h6>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <div className="d-flex justify-content-between align-items-center">
              <label className="form-label fw-semibold mb-0 text-dark">Upload Media</label>
