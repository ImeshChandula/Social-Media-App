...
const CategoryListMarketplace = () => {
    ...
    const fetchCategories = async () => {
        try {
            setLoading(true);
            const result = await CategoryService.getAllCategories('marketplace');
            if (result.success) {
  ...
  return (
    <div className="category-list-container">
            <div className="category-list-header">
                <h3>Marketplace Categories ({categories.length})</h3>
            </div>

            {categories.length === 0 ? (
                <div className="empty-state">
                    <p>No marketplace categories found. Create your first category!</p>
                </div>
            ) : (
...
export default CategoryListMarketplace